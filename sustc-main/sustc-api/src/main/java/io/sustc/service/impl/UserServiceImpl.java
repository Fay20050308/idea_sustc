...
public class UserServiceImpl implements UserService {
    ...
    public long register(RegisterUserReq req) {
        try {
            ...
            preparedStatement.setString(7, req.getQq());
            preparedStatement.setString(8, req.getWechat());
            preparedStatement.setString(9, req.getSign());
            preparedStatement.setString(10, req.getPassword());
            //判断密码等是否为空

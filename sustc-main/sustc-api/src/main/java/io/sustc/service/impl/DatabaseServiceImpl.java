    ...
    public void importData(
        ...
        for (DanmuRecord danmu : danmuRecords) {
            StringBuilder sb = new StringBuilder("""
                    insert into danmu (bv, content, time, post_time, post_mid, likeby_mid) values\s
                    """);
        ...
        for (UserRecord user : userRecords) {
            StringBuilder sb = new StringBuilder("""
                    insert into users (mid, birthday, name, coin, sex, identity, level, qq, wechat, sign, password, following) values\s
                    """);
